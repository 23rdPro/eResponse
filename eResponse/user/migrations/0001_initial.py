    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qualification', models.CharField(max_length=128, verbose_name='Title')),
                ('description', models.TextField(max_length=555, verbose_name='Describe achievement')),
                ('upload', models.FileField(blank=True, upload_to=eResponse.user.models.cert_path)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certifications', models.ManyToManyField(blank=True, related_name='certificates', to='user.certification')),
